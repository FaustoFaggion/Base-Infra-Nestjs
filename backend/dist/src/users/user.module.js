...
const user_controller_1 = require("./adapters/user.controller");
const user_service_1 = require("./useCases/user.service");
const user_repository_1 = require("./adapters/user.repository");
const prisma_module_1 = require("../../prisma/module/prisma.module");
    ...
    (0, common_1.Module)({
        ...
        providers: [user_service_1.UserService, user_repository_1.UserRepository,
            ...
            },
            {
                ...
                useExisting: user_repository_1.UserRepository
            }
        ],
