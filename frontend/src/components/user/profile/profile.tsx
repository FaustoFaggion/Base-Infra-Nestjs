            ...
            <div className="col-10 row g0 border rounded-3">
                <div className="col-4">
                    ...
                    <div className="row g-0 justify-content-center my-4 px-3">
                        ...
                        <label htmlFor="file-input" className="profile-img-action-btn col-3 p-1 text-center"> Update </label>
                        <button className="profile-img-action-btn col-3 offset-1 p-1 text-center">Delete</button>
                    </div>
